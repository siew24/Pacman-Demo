...
class Pac : public bloom::GameObject {
...
public:
	...
	void init(const std::filesystem::path texturePath = "Assets/Pacman.png", SDL_Rect pos_and_size = {0, 0, 256, 256}) {
